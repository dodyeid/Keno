...
$$p(k,s) = \frac{{s \choose k}{80-s \choose 20-k}}{80 \choose 20} $$
...
$$\sum_{k=0}^{s}\frac{{s \choose k}{a-s \choose b-k}}{a \choose b} = 1 \text{ }\forall\text{ } a,b,s,k \in \mathbb{R}_{\ge0} \text{ s.t. }a \ge b \text{ and } s>k.$$
